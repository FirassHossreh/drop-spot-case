...
4.	CRUD modülü açıklaması : CRUD Moduleleri hepsi yapili admin kullanicisi için yani uygulama role bazli calisiyor ve "admin" role'u sadece veritbanindan degistirebiliriz ama defult olarak kayıt yaptigimizda defaul normal "user" role'u oluyor. Delete Yapiliydi ama sonradan ben waitlist entity ekledim ve foreign key ile bagladim o yuzden silinmiyor ve duzeltemedim proje teslimi icin zamanim kalmadi ama genelde tum crud islemleri calisiyor
